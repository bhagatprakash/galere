...
//     <div className="my-20 max-w-full lg:max-w-[1320px] mx-auto">
//       <div className="bg-accent/20">
//         <div className="flex flex-col items-center py-5 sm:py-0">
//           <div className="w-full flex flex-col-2 sm:flex-row sm:justify-center sm:items-center sm:flex-wrap gap-5 mb-5 sm:mb-0">
//             {/* image */}
//             <div className="flex flex-col items-center sm:flex-row gap-5 mb-5">
//               <div className="bg-blue-500 rounded-[30px] w-full sm:w-[150px] h-[150px] flex items-center justify-center overflow-hidden">
//                 <img src={profile} alt="Testimonials" className="h-[90%]" />
//               </div>
//               <div className="bg-yellow-500 rounded-[30px] w-full sm:w-[150px] h-[150px] flex items-center justify-center overflow-hidden">
...
//           </div>
//           {/* slider */}
//           <div className="relative w-full md:w-2/3 mt-4 sm:mt-0 sm:ml-4">
//             <Slider {...settings}>
//               {testimonials.map((testimonial, index) => (
//                 <div key={index} className="px-2 sm:px-4">
//                   <div className="p-4 sm:p-6 bg-white rounded-lg shadow-md">
